    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foto_laporan', smartfields.fields.ImageField(blank=True, null=True, upload_to=e_psu.helpers.PathAndRename('laporan/foto'))),
                ('status_laporan', models.CharField(choices=[('BELUM', 'Belum Diproses'), ('SEDANG', 'Sedang Diproses'), ('SUDAH', 'Selesai Diproses')], max_length=6)),
                ('bentuk_penanganan_laporan', models.TextField(blank=True, null=True)),
                ('is_approve', models.BooleanField(blank=True, null=True)),
                ('alasan_ditolak', models.TextField(blank=True, null=True)),
